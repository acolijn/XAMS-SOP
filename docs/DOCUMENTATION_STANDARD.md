...
| 6.4 grouped safety information | A Hazards section on page 1 of each SOP: cryogenic burn, oxygen deficiency from xenon and nitrogen, high voltage, high pressure. | `## Hazards` |
